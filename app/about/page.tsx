      ...
      <div className="max-w-6xl mx-auto px-6 py-24 space-y-32">
        ...
        <div className="text-justify">
          <p className="text-black/80 text-base leading-8 mb-6">
            We are a renowned firm with over 37 years of experience specializing in Civil engineering and Building construction. We as a firm offer wide range of services such as Planning, Designing, Building construction services, Estimations, and Building Sanctions/Approvals Drawings with assistance.
          </p>
        ...
        <div>
          ...
          <div className="float-left mr-8 mb-6 w-full md:w-[380px]">
            <img
              src="team/Mr.Swaminathan_Photo_0003.png"
              alt="Mr. Swaminathan"
